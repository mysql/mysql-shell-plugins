...
export const mysqlInfo = {
    ...
    characterSets: new Map<string, IDBCharacterSet>(),
    dataTypes: new Map<string, IDBDataTypeDetails>(),
};
...
export const sqliteInfo = {
    ...
    // SQLite doesn't have data types per se, but column affinities (which are kind of a type hint, but can be
    // ignored) and storage classes for each value.
    dataTypes: new Map<string, IDBDataTypeDetails>(),
};
