...
import {
    ...
    CompatibilityIssueEnum,
    MigrationButtonEnum,
    StepStatusEnum,
    TileStepStatusEnum,
    MockMigrationStatusEnum
} from "./constants.js";

export type MigrationType = MigrationTypeEnum.ColdMigration | MigrationTypeEnum.HotMigration;
export type NetworkConnectivity = NetworkConnectivityEnum.SiteToSite | NetworkConnectivityEnum.SshTunnel
    | NetworkConnectivityEnum.LocalSshTunnel;
