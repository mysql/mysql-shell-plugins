...
describe("ProtocolMds tests", (): void => {
    ...
    it("Test functions with undefined input", () => {
        ...
        testStandardFields(result, ShellAPIMrs.MrsAddService, { enabled: true,
    ...
    it("Test service requests", () => {
        let result = ProtocolMrs.getRequestAddService("rootContext", "localhost", true, { urlProtocol: "xProt",
            isDefault: true, comments: "lorem", moduleSessionId: "session1", interactive: true,
            raiseExceptions: true });
        testStandardFields(result, ShellAPIMrs.MrsAddService,  { url_context_root: "rootContext",
            enabled: true, url_host_name: "localhost" });

        result = ProtocolMrs.getRequestGetService("rootContext", "localhost", 1, { getDefault: true,
            autoSelectSingle: false, moduleSessionId: "sessionId1", interactive: false, raiseExceptions: false,
            returnFormatted: false });
        testStandardFields(result, ShellAPIMrs.MrsGetService,  { url_context_root: "rootContext",
            service_id: 1, url_host_name: "localhost" });

        result = ProtocolMrs.getRequestListServices({ moduleSessionId: "session1",
            interactive: false, raiseExceptions: false, returnFormatted: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsListServices, { module_session_id: "session1",
            interactive: false, raise_exceptions: false, return_formatted: false });

        result = ProtocolMrs.getRequestEnableService( { urlContextRoot: "rootContext",
            urlHostName: "localhost",  serviceId: 1,  moduleSessionId: "session1",
            interactive: false, raiseExceptions: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsEnableService, { url_context_root: "rootContext",
            url_host_name: "localhost",  service_id: 1,  module_session_id: "session1",
            interactive: false, raise_exceptions: false });

        result = ProtocolMrs.getRequestDisableService({ urlContextRoot: "rootContext",
            urlHostName: "localhost",  serviceId: 1,  moduleSessionId: "session1",
            interactive: false, raiseExceptions: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsDisableService, { url_context_root: "rootContext",
            url_host_name: "localhost",  service_id: 1,  module_session_id: "session1",
            interactive: false, raise_exceptions: false });

        result = ProtocolMrs.getRequestDeleteService({ urlContextRoot: "rootContext",
            urlHostName: "localhost",  serviceId: 1,  moduleSessionId: "session1",
            interactive: false, raiseExceptions: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsDeleteService, { url_context_root: "rootContext",
            url_host_name: "localhost",  service_id: 1,  module_session_id: "session1",
            interactive: false, raise_exceptions: false });

        result = ProtocolMrs.getRequestSetServiceDefault({ urlContextRoot: "rootContext",
            urlHostName: "localhost",  serviceId: 1,  moduleSessionId: "session1",
            interactive: false, raiseExceptions: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsSetServiceDefault, { url_context_root: "rootContext",
            url_host_name: "localhost",  service_id: 1,  module_session_id: "session1",
            interactive: false, raise_exceptions: false });

        result = ProtocolMrs.getRequestSetServiceContextPath({ urlContextRoot: "rootContext",
            urlHostName: "localhost", value: "test val", serviceId: 1,  moduleSessionId: "session1",
            interactive: false, raiseExceptions: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsSetServiceContextPath, { url_context_root: "rootContext",
            url_host_name: "localhost", value: "test val",  service_id: 1,  module_session_id: "session1",
            interactive: false, raise_exceptions: false });

        result = ProtocolMrs.getRequestSetServiceProtocol({ urlContextRoot: "rootContext",
            urlHostName: "localhost", value: "test val", serviceId: 1,  moduleSessionId: "session1",
            interactive: false, raiseExceptions: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsSetServiceProtocol, { url_context_root: "rootContext",
            url_host_name: "localhost", value: "test val",  service_id: 1,  module_session_id: "session1",
            interactive: false, raise_exceptions: false });

        result = ProtocolMrs.getRequestSetServiceComments({ urlContextRoot: "rootContext",
            urlHostName: "localhost", value: "test val", serviceId: 1,  moduleSessionId: "session1",
            interactive: false, raiseExceptions: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsSetServiceComments, { url_context_root: "rootContext",
            url_host_name: "localhost", value: "test val",  service_id: 1,  module_session_id: "session1",
            interactive: false, raise_exceptions: false });

        result = ProtocolMrs.getRequestUpdateService({ urlContextRoot: "rootContext",
            urlHostName: "localhost", value: "test val", serviceId: 1,  moduleSessionId: "session1",
            interactive: false, raiseExceptions: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsUpdateService, { url_context_root: "rootContext",
            url_host_name: "localhost", value: "test val",  service_id: 1,  module_session_id: "session1",
            interactive: false, raise_exceptions: false });
    });

    it("Test schema requests", () => {
        let result = ProtocolMrs.getRequestAddSchema({ schemaName: "testDb", serviceId: 1,
        ...
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsAddSchema, { schema_name: "testDb", service_id: 1,
        ...
        result = ProtocolMrs.getRequestGetSchema({ requestPath: "/home/user1", schemaName: "testDb",
        ...
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsGetSchema, { request_path: "/home/user1",
        ...
        result = ProtocolMrs.getRequestListSchemas({ serviceId: 1, includeEnableState: true,
            moduleSessionId: "session1", interactive: false, raiseExceptions: false, returnFormatted: false});
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsListSchemas, { service_id: 1, include_enable_state: true,
            module_session_id: "session1", interactive: false, raise_exceptions: false, return_formatted: false });

        result = ProtocolMrs.getRequestEnableSchema({ schemaName: "testDb", serviceId: 1,
            moduleSessionId: "session1", interactive: false, raiseExceptions: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsEnableSchema, { schema_name: "testDb", service_id: 1,
            module_session_id: "session1", interactive: false, raise_exceptions: false });

        result = ProtocolMrs.getRequestDisableSchema({ schemaName: "testDb", serviceId: 1,
            schemaId: 1, moduleSessionId: "session1", interactive: false, raiseExceptions: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsDisableSchema, { schema_name: "testDb", service_id: 1,
            schema_id: 1, module_session_id: "session1", interactive: false, raise_exceptions: false });

        result = ProtocolMrs.getRequestDeleteSchema({ schemaName: "testDb", serviceId: 1,
            schemaId: 1, moduleSessionId: "session1", interactive: false, raiseExceptions: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsDeleteSchema, { schema_name: "testDb", service_id: 1,
            schema_id: 1, module_session_id: "session1", interactive: false, raise_exceptions: false });

        result = ProtocolMrs.getRequestSetSchemaName({ schemaName: "testDb", serviceId: 1,
            schemaId: 1, value: "newVal", moduleSessionId: "session1", interactive: false, raiseExceptions: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsSetSchemaName, { schema_name: "testDb", service_id: 1,
            schema_id: 1,  value: "newVal", module_session_id: "session1", interactive: false,
            raise_exceptions: false });

        result = ProtocolMrs.getRequestSetSchemaRequestPath({ schemaName: "testDb", serviceId: 1,
            schemaId: 1, value: "newVal", moduleSessionId: "session1", interactive: false, raiseExceptions: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsSetSchemaRequestPath, { schema_name: "testDb",
            service_id: 1, schema_id: 1,  value: "newVal", module_session_id: "session1", interactive: false,
            raise_exceptions: false });

        result = ProtocolMrs.getRequestSetSchemaRequiresAuth({ schemaName: "testDb", serviceId: 1,
            schemaId: 1, value: true, moduleSessionId: "session1", interactive: false, raiseExceptions: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsSetSchemaRequiresAuth, { schema_name: "testDb",
            service_id: 1, schema_id: 1,  value: true, module_session_id: "session1", interactive: false,
            raise_exceptions: false });

        result = ProtocolMrs.getRequestSetSchemaItemsPerPage({ schemaName: "testDb", serviceId: 1,
            schemaId: 1, value: 1, moduleSessionId: "session1", interactive: false, raiseExceptions: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsSetSchemaItemsPerPage, { schema_name: "testDb",
            service_id: 1, schema_id: 1,  value: 1, module_session_id: "session1", interactive: false,
            raise_exceptions: false });

        result = ProtocolMrs.getRequestSetSchemaComments({ schemaName: "testDb", serviceId: 1,
            schemaId: 1, value: "newVal", moduleSessionId: "session1", interactive: false, raiseExceptions: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsSetSchemaComments, { schema_name: "testDb",
            service_id: 1, schema_id: 1,  value: "newVal", module_session_id: "session1", interactive: false,
            raise_exceptions: false });

        result = ProtocolMrs.getRequestUpdateSchema({ schemaName: "testDb", serviceId: 1,
            schemaId: 1, value: "newVal", moduleSessionId: "session1", interactive: false, raiseExceptions: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsUpdateSchema, { schema_name: "testDb",
            service_id: 1, schema_id: 1,  value: "newVal", module_session_id: "session1", interactive: false,
            raise_exceptions: false });
    });

    it("Test content requests", () => {
        let result = ProtocolMrs.getRequestAddContentSet("content", 1, { requestPath: "path", requiresAuth: true,
            moduleSessionId: "session1", interactive: false, raiseExceptions: false });
        testStandardFields(result, ShellAPIMrs.MrsAddContentSet, { content_dir: "content", service_id: 1 });

        result = ProtocolMrs.getRequestListContentSets(1, { includeEnableState: true, moduleSessionId: "sessionId1",
            interactive: false, raiseExceptions: false, returnFormatted: false });
        testStandardFields(result, ShellAPIMrs.MrsListContentSets, { service_id: 1 });

        result = ProtocolMrs.getRequestGetContentSet("/home", { contentSetId: 1, serviceId: 1, autoSelectSingle: false,
            moduleSessionId: "sessionId1", interactive: false });
        testStandardFields(result, ShellAPIMrs.MrsGetContentSet, { request_path: "/home" });

        result = ProtocolMrs.getRequestEnableContentSet({ serviceId: 1, contentSetId: 2,
            moduleSessionId: "sessionId1", interactive: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsEnableContentSet, { service_id: 1, content_set_id: 2,
            module_session_id: "sessionId1", interactive: false });

        result = ProtocolMrs.getRequestDisableContentSet({ serviceId: 1, contentSetId: 2,
            moduleSessionId: "sessionId1", interactive: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsDisableContentSet, { service_id: 1, content_set_id: 2,
            module_session_id: "sessionId1", interactive: false });

        result = ProtocolMrs.getRequestDeleteContentSet({ serviceId: 1, contentSetId: 2,
            moduleSessionId: "sessionId1", interactive: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsDeleteContentSet, { service_id: 1, content_set_id: 2,
            module_session_id: "sessionId1", interactive: false });
    });

    it("Test content requests", () => {
        let result = ProtocolMrs.getRequestAddDbObject({ dbObjectName: "object1", dbObjectType: "table",
        ...
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsAddDbObject, { db_object_name: "object1", 
        ...
        result = ProtocolMrs.getRequestGetDbObject("/home", "myDb", { dbObjectId: 1, schemaId: 1,
            moduleSessionId: "session1", interactive: false });
        testStandardFields(result, ShellAPIMrs.MrsGetDbObject, { request_path: "/home", db_object_name: "myDb" });

        result = ProtocolMrs.getRequestListDbObjects(1, { includeEnableState: true,
            moduleSessionId: "session1", interactive: false, raiseExceptions: false, returnFormatted: false });
        testStandardFields(result, ShellAPIMrs.MrsListDbObjects, { schema_id: 1 });

        result = ProtocolMrs.getRequestSetDbObjectRequestPath(1, "/home", {  moduleSessionId: "session1",
            interactive: false });
        testStandardFields(result, ShellAPIMrs.MrsSetDbObjectRequestPath, { db_object_id: 1, request_path: "/home" });

        result = ProtocolMrs.getRequestSetDbObjectCrudOperations(1, [], "add", {  moduleSessionId: "session1",
            interactive: false });
        testStandardFields(result, ShellAPIMrs.MrsSetDbObjectCrudOperations, { db_object_id: 1,
            crud_operations: [],  crud_operation_format: "add"});

        result = ProtocolMrs.getRequestEnableDbObject("myDb", 1, {  dbObjectId: 11,
            moduleSessionId: "session1", interactive: false });
        testStandardFields(result, ShellAPIMrs.MrsEnableDbObject, { db_object_name: "myDb", schema_id: 1 });

        result = ProtocolMrs.getRequestDisableDbObject("myDb", 1, {  dbObjectId: 11,
            moduleSessionId: "session1", interactive: false });
        testStandardFields(result, ShellAPIMrs.MrsDisableDbObject, { db_object_name: "myDb", schema_id: 1 });

        result = ProtocolMrs.getRequestDeleteDbObject("myDb", 1, {  dbObjectId: 11,
            moduleSessionId: "session1", interactive: false });
        testStandardFields(result, ShellAPIMrs.MrsDeleteDbObject, { db_object_name: "myDb", schema_id: 1 });
    });

    it("Test other requests", () => {
        let result = ProtocolMrs.getRequestListContentFiles({ contentSetId: 1, includeEnableState: true, 
            moduleSessionId: "session1", interactive: false, raiseExceptions: false, returnFormatted: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsListContentFiles, { content_set_id: 1,
        ...
        result = ProtocolMrs.getRequestConfigure({ enableMrs: true, moduleSessionId: "sessionId1",
            interactive: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsConfigure, { enable_mrs: true,
            module_session_id: "sessionId1", interactive: false });

        result = ProtocolMrs.getRequestStatus({ moduleSessionId: "session1",
            interactive: false, raiseExceptions: false, returnFormatted: false });
        testStandardFieldsWithKwArgs(result, ShellAPIMrs.MrsStatus, { module_session_id: "session1",
            interactive: false, raise_exceptions: false, return_formatted: false });
    });
