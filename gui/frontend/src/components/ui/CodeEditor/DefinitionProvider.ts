...
import { languages, Position, ProviderResult, Definition, LocationLink } from ".";
...
export class DefinitionProvider implements languages.DefinitionProvider {
    ...
    public provideDefinition(model: ICodeEditorModel, position: Position): ProviderResult<Definition | LocationLink[]> {
        ...
        if (block) {
            ...
            return services.findDefinition(block, position);
        }
    }
}
