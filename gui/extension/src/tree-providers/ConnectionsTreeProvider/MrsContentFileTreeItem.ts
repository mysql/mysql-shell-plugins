...
import { IMrsContentFileData } from "../../../../frontend/src/communication/ShellResponseTypes";
...
export class MrsContentFileTreeItem extends MrsTreeBaseItem {
    public contextValue = "mrsContentFile";

    public constructor(
        label: string,
        public value: IMrsContentFileData,
        entry: IConnectionEntry) {
        super(label, entry, true, value.enabled ? "mrsContentFile.svg" : "mrsContentFileDisabled.svg");
    }
}
