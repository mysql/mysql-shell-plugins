...
export class SchemaTableColumnTreeItem extends ConnectionsTreeBaseItem {
    public contextValue = "schemaTableColumnItem";
    ...
    public constructor(
        ...
        super(name, schema, entry, "schemaTableColumn.svg", false);
    }
