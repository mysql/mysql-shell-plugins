...
export class SchemaTableTreeItem extends ConnectionBaseTreeItem<ICdmTableEntry> {
    public override contextValue = "schemaTableItem";

    public constructor(dataModelEntry: ICdmTableEntry, iconName: string) {
