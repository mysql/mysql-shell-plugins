...
import { IMrsSchemaData } from "../../../../frontend/src/communication/ShellResponseTypes";
...
export class MrsSchemaTreeItem extends MrsTreeBaseItem {
    public contextValue = "mrsSchema";

    public constructor(
        label: string,
        public value: IMrsSchemaData,
        entry: IConnectionEntry) {
        super(label, entry, true, value.enabled === 1 ? "schema.svg" : "schemaDisabled.svg");
    }
}
