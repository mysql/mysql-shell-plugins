...
import { CommandResultToolbar } from "./CommandResultToolbar";
...
export class CommandResult implements interfaces.ICommandResult {
    ...
    /** Result graphs*/
    public graph: WebElement;

    /** Result grids for SELECT queries*/
    public grid: CommandResultGrid;

    /** Result grid toolbar*/
    public toolbar: interfaces.ICommandResultToolbar;

    /** Result sql preview*/
    public preview: interfaces.ICommandResultPreview;
        ...
        if (!fromScript) {
            ...
            try {
                ...
                if (results.length > 0) {
                    ...
                    console.error(`[DEBUG] Last result id found: ${id}`);
