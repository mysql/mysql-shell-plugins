...
ALTER TABLE `profile_has_db_connection`
  RENAME TO `profile_has_db_connection_old`;
...
INSERT INTO `profile_has_db_connection` (`profile_id`, `db_connection_id`, `folder_path_id`, `index`)
  SELECT `profile_id`, `db_connection_id`, 1, `index` FROM `profile_has_db_connection_old`;

DROP TABLE `profile_has_db_connection_old`;
