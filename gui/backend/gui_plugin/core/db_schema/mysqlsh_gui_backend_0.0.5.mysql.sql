...
CREATE TABLE IF NOT EXISTS `module_data_has_tag` (
  ...
  INDEX `fk_module_data_has_tag_tag1_idx` (`tag_id` ASC) VISIBLE,
  INDEX `fk_module_data_has_tag_module_data1_idx` (`profile_id` ASC, `module_data_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `db_type` (`id`, `name`, `classname`) VALUES (1, 'MySQL', 'gui_plugin.core.DbSession.DbMysqlSession');
INSERT INTO `db_type` (`id`, `name`, `classname`) VALUES (2, 'Sqlite', 'gui_plugin.core.DbSession.DbSqliteSession');
