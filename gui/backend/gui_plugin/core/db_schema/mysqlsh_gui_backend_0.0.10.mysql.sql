...
CREATE TABLE IF NOT EXISTS `profile_has_module_data` (
  ...
  INDEX `fk_profile_has_module_data_folder_path1_idx` (`folder_path` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `user_group_has_module_data` (
  ...
  INDEX `fk_user_group_has_module_data_folder_path1_idx` (`folder_path` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- ATTACH DATABASE 'mysqlsh_gui_backend_log_0.0.10.sqlite3' as logs;
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `module_data_type` (`id`, `caption`, `active`) VALUES (1, 'File', NULL);
INSERT INTO `module_data_type` (`id`, `caption`, `active`) VALUES (2, 'Script', NULL);
INSERT INTO `module_data_type` (`id`, `caption`, `active`) VALUES (3, 'JSON', NULL);
INSERT INTO `module_data_type` (`id`, `caption`, `active`) VALUES (4, 'File Link', NULL);
