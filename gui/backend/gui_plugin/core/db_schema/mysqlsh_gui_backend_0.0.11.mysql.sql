...
CREATE TABLE IF NOT EXISTS `module_data` (
  ...
  INDEX `fk_module_data_module_data_category1_idx` (`module_data_category_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- ATTACH DATABASE 'mysqlsh_gui_backend_log_0.0.11.sqlite3' as logs;
