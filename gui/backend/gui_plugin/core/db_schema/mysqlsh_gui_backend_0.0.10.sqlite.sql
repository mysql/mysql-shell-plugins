...
CREATE INDEX `fk_profile_has_module_data_folder_path1_idx` ON `profile_has_module_data` (`folder_path` ASC);
...
CREATE INDEX `fk_user_group_has_module_data_folder_path1_idx` ON `user_group_has_module_data` (`folder_path` ASC);
