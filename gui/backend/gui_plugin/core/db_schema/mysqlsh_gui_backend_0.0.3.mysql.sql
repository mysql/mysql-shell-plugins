...
CREATE INDEX `fk_db_connection_db_type1_idx` ON `db_connection` (`db_type_id` ASC) VISIBLE;
...
CREATE INDEX `fk_log_user1_idx` ON `log` (`user_id` ASC) VISIBLE;

CREATE INDEX `fk_log_session1_idx` ON `log` (`session_id` ASC) VISIBLE;
...
CREATE INDEX `fk_message_session1_idx` ON `message` (`session_id` ASC) VISIBLE;
...
CREATE INDEX `fk_module_data_module1_idx` ON `module_data` (`module_id` ASC) VISIBLE;

CREATE INDEX `fk_module_data_module_data_type1_idx` ON `module_data` (`module_data_type_id` ASC) VISIBLE;

CREATE INDEX `fk_module_data_user_group1_idx` ON `module_data` (`user_group_id` ASC) VISIBLE;

CREATE INDEX `fk_module_data_module_data_privilege1_idx` ON `module_data` (`group_data_privilege_id` ASC) VISIBLE;

CREATE INDEX `module_data_caption_idx` ON `module_data` (`caption` ASC) VISIBLE;

CREATE INDEX `module_data_folder_path_idx` ON `module_data` (`folder_path` ASC) VISIBLE;
...
CREATE INDEX `fk_privilege_privilege_type1_idx` ON `privilege` (`privilege_type_id` ASC) VISIBLE;
...
CREATE TABLE IF NOT EXISTS `profile_has_db_connection` (
  ...
  `db_connection_group_id` INT NOT NULL,
  `active` TINYINT NULL DEFAULT 1,
...
CREATE INDEX `fk_profile_has_db_connection_db_connection_group1_idx` ON `profile_has_db_connection` (`db_connection_group_id` ASC) VISIBLE;
...
CREATE INDEX `fk_profile_has_module_data_module_data1_idx` ON `profile_has_module_data` (`module_data_id` ASC) VISIBLE;

CREATE INDEX `fk_rofile_has_module_data_profile1_idx` ON `profile_has_module_data` (`profile_id` ASC) VISIBLE;

CREATE INDEX `fk_profile_has_module_data_module_data_pri_idx` ON `profile_has_module_data` (`module_data_privilege_id` ASC) VISIBLE;
...
CREATE INDEX `fk_profile_has_module_options_profile1_idx` ON `profile_has_module_options` (`profile_id` ASC) VISIBLE;

CREATE INDEX `fk_profile_has_module_options_module1_idx` ON `profile_has_module_options` (`module_id` ASC) VISIBLE;
...
CREATE INDEX `fk_role_has_privilege_privilege1_idx` ON `role_has_privilege` (`privilege_id` ASC) VISIBLE;

CREATE INDEX `fk_role_has_privilege_role_idx` ON `role_has_privilege` (`role_id` ASC) VISIBLE;
...
CREATE INDEX `fk_session_users1_idx` ON `session` (`user_id` ASC) VISIBLE;

CREATE INDEX `fk_session_session1_idx` ON `session` (`continued_session_id` ASC) VISIBLE;
...
CREATE INDEX `fk_users_has_role_role1_idx` ON `user_has_role` (`role_id` ASC) VISIBLE;

CREATE INDEX `fk_users_has_role_users1_idx` ON `user_has_role` (`user_id` ASC) VISIBLE;
