...
CREATE TABLE IF NOT EXISTS `mysql_rest_service_metadata`.`content_file` (
  ...
  `file_size` BIGINT GENERATED ALWAYS AS (LENGTH(content)) STORED,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
USE `mysql_rest_service_metadata`;
CREATE  OR REPLACE SQL SECURITY INVOKER VIEW schema_version (major, minor, patch) AS SELECT 0, 0, 19;
