...
-- -----------------------------------------------------------------------------
-- PROCEDURE `mysql_tasks`.`msm_create_3.0.1`
-- -----------------------------------------------------------------------------
-- Stored procedure to install schema TABLEs for version 3.0.1
-- -----------------------------------------------------------------------------
DROP PROCEDURE IF EXISTS `msm_create_3.0.1`%%
CREATE PROCEDURE `msm_create_3.0.1`()
SQL SECURITY INVOKER
BEGIN
    -- -----------------------------------------------------
...
BEGIN
    ...
    IF item_count = 0 THEN
        ...
        CALL `mysql_tasks`.`msm_create_3.0.1`();
    ELSE
...
USE `mysql_tasks`;
DROP PROCEDURE `msm_create_3.0.1`;
...
-- -----------------------------------------------------------------------------
-- PROCEDURE `mysql_tasks`.`msm_auth_3.0.1`
-- -----------------------------------------------------------------------------
-- Stored procedure to setup authorization for version 3.0.1
-- -----------------------------------------------------------------------------
DROP PROCEDURE IF EXISTS `msm_auth_3.0.1`%%
CREATE PROCEDURE `msm_auth_3.0.1`()
SQL SECURITY INVOKER
BEGIN
...
BEGIN
    ...
    IF @msm_schema_init THEN
        CALL `mysql_tasks`.`msm_auth_3.0.1`();
    ELSE
        IF version_str = '3.0.0' THEN
