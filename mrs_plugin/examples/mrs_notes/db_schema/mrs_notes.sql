...
CREATE TABLE IF NOT EXISTS `mrs_notes`.`note` (
  ...
  `shared` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'The shared column is automatically updated by AFTER INSERT / DELETE triggers on user_has_note.',
